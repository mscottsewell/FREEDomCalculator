        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex justify-between">
              ...
              <span className="text-lg font-semibold currency-blue">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-lg font-semibold currency-green">
                {formatCurrency(results.realPurchasingPower)}
              </span>
            </div>
            <div className="flex justify-between">
              <span>Purchasing Power Lost:</span>
              <span className="text-lg font-semibold currency-red">
