...
const isAutoLoanData = (v: unknown): v is AutoLoanData =>
  ...
  ['loanAmount', 'interestRate', 'loanTerm'].every(k => {
  ...
  return (
    <div className="space-y-5 sm:space-y-6">
      ...
      <div
        ...
        style={{ background: 'linear-gradient(135deg, oklch(0.40 0.10 195), oklch(0.22 0.07 195))' }}
      >
        <div
        ...
        <div className="relative flex items-start gap-3 sm:gap-4">
          ...
          <div>
            <h2 className="text-base sm:text-xl font-bold tracking-tight">Know Before You Owe 🚗</h2>
            <p className="mt-0.5 text-xs sm:text-sm text-white/80 max-w-none">
              That monthly payment is only half the story. See the full cost of financing a car — and how the
              loan term quietly changes <em>what you really pay</em>.
            </p>
          </div>
        </div>
      </div>
